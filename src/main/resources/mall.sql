/*
 ...
 Source Server         : CT7.6.1
 Source Server Type    : MySQL
 Source Server Version : 80021
 Source Host           : 192.168.95.129:3306
 Source Schema         : mall
...
CREATE TABLE `mall_category`  (
  ...
  `sort_order` int(0) NULL DEFAULT 1 COMMENT '排序编号,同类展示顺序,数值相等则自然排序',
...
INSERT INTO `mall_category` VALUES (100002, 0, '数码3C', 1, 1, '2000-03-25 16:46:21', '2000-03-25 16:46:21');
INSERT INTO `mall_category` VALUES (100003, 0, '服装箱包', 1, 2, '2000-03-25 16:49:53', '2000-03-25 16:49:53');
...
INSERT INTO `mall_category` VALUES (100031, 100006, '进口冰箱', 1, 2, '2020-11-18 22:13:26', '2020-11-18 22:13:28');
...
CREATE TABLE `mall_user`  (
  ...
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '最后一次更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
INSERT INTO `mall_user` VALUES (5, 'admin1', 'e00cf25ad42683b3df678c61f42c6bda', 'admin@qq1.com', NULL, NULL, NULL, 1, '2020-11-17 22:36:19', '2020-11-17 22:36:19');
INSERT INTO `mall_user` VALUES (8, 'jack', '4ff9fc6e4e5d5f590c4f2134a8cc96d1', 'jack@qq.com', NULL, NULL, NULL, 1, '2020-11-18 22:08:28', '2020-11-18 22:08:28');
